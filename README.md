...
A results-driven **DevOps and SRE Leader** with **10+ years of experience** architecting and building resilient, large-scale AWS infrastructure and automation pipelines. I have a proven track record of implementing robust CI/CD frameworks, container orchestration, and observability solutions that empower high-performance engineering teams.

My expertise includes **cloud cost optimization (FinOps)** and operational excellence, specifically applied to **AI-driven solutions** across DevOps workflows. I am known for mentoring teams, eliminating bottlenecks, and driving platform scalability.
